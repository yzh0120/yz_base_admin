...
<script>
	export default{
		data(){
			...
			return {
				formData:{
					...
					// titleWidth:"200px",
					list:[
						{ type:"input",field:"__input",title:"输入框",tip:true,rules:[
		...
		mounted() {
      this.formData.data.__input = "mounted修改mounted修改mounted修改mounted修改mounted修改mounted修改mounted修改mounted修改mounted修改mounted修改"
		},
		methods:{
			filter(query){
