...
<template>
	        <!-- 多级表头 -->
			<el-table-column  :label="item.title" :key="item.title" :width="item.width" :align="align" v-if="item.children">
			...
			:key="item.title" :width="item.width" :align="align" >
				<!-- 跨组件传插槽 -->
			...
			:width="item.width" :align="align" :formatter="item.format"
